...
const ViewResturant = () => {
    return (
        <>
            ...
            <div className='mx-auto flex flex-row overflow-y-auto px-3 overflow-visible h-fit'>
                <div className='w-4/12 flex flex-col '>
                    <div className=' mt-5 border h-36 mx-4 flex flex-row border rounded-lg bg-gradient-to-r from-cyan-500 to-blue-500'>
                        <div className='w-4/12 mt-5 ml-4'>
                            <img src="https://png.pngtree.com/png-vector/20220706/ourmid/pngtree-food-logo-png-image_5687717.png" width={50} alt="" />
                        </div>
                    ...
                    <div className='mt-2 border mx-4 flex flex-col border rounded-lg'>
                        <div className='flex flex-row mx-auto border-b  m-4 pb-4 items-center'>
                            <p className='w-1/2 font-semibold ml-3'>Net Wallet Balance (Ending Mar 2024)	</p>
                            <a href="" className='mx-auto border px-2 bg-red-500 text-white rounded-full'>₹ 0</a>
                        </div>
                        <div className='flex flex-row mx-auto border-b  m-4 pb-4 items-center'>
                            <p className='w-1/2 font-semibold ml-3'>Net Wallet Balance (Ending Mar 2024)	</p>
                            <a href="" className='mx-auto border px-2 bg-red-500 text-white rounded-full'>₹ 0</a>
                ...
                >
                    ...
                    >
                        <div
                            ...
                            style={{ boxSizing: "border-box", position: "relative", padding: "0.5rem" }}
                        >
                            <ul
