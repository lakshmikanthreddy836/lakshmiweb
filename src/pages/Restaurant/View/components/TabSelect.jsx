...
export const TabSelect = ({ isActive, children, onClick }) => (
  <button
    className={`w-full  justify-center text-center group inline-flex items-center px-2 py-4 border-b-2 font-medium text-sm leading-5 cursor-pointer whitespace-nowrap ${
      isActive
